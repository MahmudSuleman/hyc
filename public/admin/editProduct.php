            ...
            <form action="editProduct.php?product_id=<?=$product['product_id']?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select name="category" id="category" class="form-control">
                        <option value="men" <?php if(!empty($product) && $product['category'] == 'men'){echo "selected";} ?>>Men</option>
                        <option value="women" <?php if(!empty($product) && $product['category'] == 'women'){echo "selected";} ?>>Women</option>
                        <option value="babies" <?php if(!empty($product) && $product['category'] == 'baby'){echo "selected";} ?>>Babies</option>
                    </select>
                </div>
